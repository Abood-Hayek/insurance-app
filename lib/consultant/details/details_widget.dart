          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: StreamBuilder<List<PolicyRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<PolicyRecord> button2PolicyRecordList = snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final button2PolicyRecord =
                        button2PolicyRecordList.isNotEmpty
                            ? button2PolicyRecordList.first
                            : null;
                    return InkWell(
                      ...
                      onTap: () async {
                        if (button2PolicyRecord?.isStatus == true) {}
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
