            ...
            child: Stack(
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 199.0),
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          context.pushNamed('listCustomer');
                        },
                      ),
                      FlutterFlowIconButton(
                        borderColor:
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 160.0, 0.0, 50.0),
                    child: PagedListView<DocumentSnapshot<Object?>?,
                      ...
                      builderDelegate:
                          PagedChildBuilderDelegate<ConsultantRecord>(
                        ...
                        itemBuilder: (context, _, listViewIndex) {
                          final listViewConsultantRecord = _model
                                    ...
                                    StreamBuilder<List<ConsultantRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ConsultantRecord>
                                            imageConsultantRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final imageConsultantRecord =
                                            imageConsultantRecordList.isNotEmpty
                                                ? imageConsultantRecordList
                                                    .first
                                                : null;
                                        return ClipRRect(
                                        ...
                                        children: [
                                          ...
                                          StreamBuilder<List<ConsultantRecord>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ConsultantRecord>
                                                  iconButtonConsultantRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final iconButtonConsultantRecord =
                                                  iconButtonConsultantRecordList
                                                          .isNotEmpty
                                                      ? iconButtonConsultantRecordList
                                                          .first
